...
public class RatingConstants {
    ...
    public static final String SQL_SELECT_BY_USER_ID_AND_OBJECT_ID = "SELECT " + RATING_TABLE + " FROM rating " +
            "WHERE identity_id = ? AND object_id = ?";
    public static final String SQL_SELECT_BY_OBJECT_ID = "SELECT object_id, identity_id, " + RATING_TABLE + " FROM rating " +
            "WHERE object_id = ?";
}
