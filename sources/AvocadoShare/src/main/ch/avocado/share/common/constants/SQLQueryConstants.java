...
public class SQLQueryConstants {
    ...
    public static final String SELECT_USER_QUERY = "SELECT " + SELECT_USER_SELECTED_COLUMNS + " FROM  avocado_share.identity AS I JOIN avocado_share.email AS E ON I.id=E.identity_id JOIN avocado_share.access_control AS O ON O.id=I.id WHERE I.id=?";
