...
public class SQLQueryConstants {
    ...
    public static final String GET_GROUP_BY_ID = "SELECT id, name, description, creation_date FROM access_group AS g JOIN access_control AS o ON g.id = o.id WHERE o.id = ?";
