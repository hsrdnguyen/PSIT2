...
\requirementsubsection{Sicherheit}
\requirement{00}{Zugriffskontrolle}
Beim Aufrufen der verschiedenen Seiten prüft das System immer, ob der Benutzer angemeldet ist. Falls er nicht angemeldet ist, wird er auf die Log-in Seite verwiesen. Davon ausgenommen sind nur die Seiten, zur Registrierung (\texttt{/F0200/} Registrierung) und diejenige zur Anmeldung (\refreq{An- und Abmelden}). \\
...
\requirement{10}{An- und Abmelden}
...
\requirement{20}{Passwort zurücksetzen}
...
\requirementsubsection{Benutzerverwaltung}
...
\requirement{10}{Benutzerdaten ändern}
...
\requirementsubsection{Gruppenverwaltung}
...
\requirement{00}{Gruppe erstellen}
...
\requirement{10}{Gruppe bearbeiten}
...
\requirement{20}{Gruppenrechte bearbeiten}
...
\requirementsubsection{Modulverwaltung}
...
\requirement{00}{Modul erstellen}
...
\requirement{10}{Modul bearbeiten}
...
\requirement{20}{Modulrechte bearbeiten}
...
\end{table}
\requirementsubsection{Dateimanagement}
...
\requirement{00}{Datei hochladen}
...
\requirement{10}{Datei bearbeiten}
...
\requirement{20}{Dateirechte bearbeiten}
...
\requirement{50}{Datei kategorisieren}
...
\requirementsubsection{Suche}
\requirement{00}{Suche}
...
\requirement{10}{Zugriff beantragen}
