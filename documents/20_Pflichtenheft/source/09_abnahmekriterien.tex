...
\begin{abnahmefall}[]
	...
	\ereignis{
		Der abgemeldete Benutzer gibt seine E-Mail-Addresse in das Formular, um sein Passwort zurückzusetzten, ein, füllt danach das \gls{Captcha} aus und lässt sich ein neues Passwort generieren.
	}
	\ergebnis{
		Der Benutzer ist abgemeldet und wird auf die Startseite der Applikation umgeleitet.
	}
