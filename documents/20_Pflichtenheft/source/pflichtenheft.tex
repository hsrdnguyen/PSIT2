...
\newcommand{\untertitel}{Java-Applikation zur Dimensionierung von PID-Reglern}
...
\newcommand{\dozent}{Niklaus Peter}
\newcommand{\betreuer}{Gut Richard, Gertiser Anita,\\ Buchschacher Pascal}
...
\begin{titlepage}
    \begin{flushleft}
        ...
        \vfill
        \large{
            %\hspace{-0.83cm} \includegraphics{images/fhnw_logo_full}\\
            %\line(1,0){165} 
